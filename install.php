...
$query = mysqli_query($conn,"CREATE TABLE `hexa-forum_users_tags` (
 ...
 PRIMARY KEY (`user_id`,`tag_id`)
				...
				file_put_contents("installer.zip", fopen("https://flarum.myhexa.co/installer-files.zip", 'r'));
				$zip = new ZipArchive;
